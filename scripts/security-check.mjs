...
const cleanupUploadVerificationMigration =
  "supabase/migrations/20260721124500_cleanup_admin_upload_verification_review.sql";
...
check(
  "admin upload verification cleanup migration exists",
  existsSync(join(root, cleanupUploadVerificationMigration)),
);
